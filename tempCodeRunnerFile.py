...
### AI-Driven Vendor Invoice Risk Assessment and Freight Cost Prediction

This innternal analytics portal leverages advanced machine learning models to 
...
- Reduces invooice fraud & anomalies
- Faster finance operations
''')

#-----------------------------------------------------
# Fright Cost Prediction Section
# ----------------------------------------------------
if selected_model == "Freight Cost Prediction":
    ...
    **Objective**
    ...
    to suppot budgeting, forecasting and vendor negotiations. 
    """)
    ...
    if submit_freight:
        ...
        st.success("Predction completed successfully.")
...
#-----------------------------------------------------
# Invoice Manual Approval Flag Section
# ----------------------------------------------------  
    ...
    st.markdown("""
    **Objective**
    Predict whether a vendor invoice requires manual approval based on **flagged for manual approval**
